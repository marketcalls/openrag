...
export type ModelCatalogItemOut = components['schemas']['ModelCatalogItemOut'];
export type CatalogCapability = ModelCatalogItemOut['capabilities'][number];
export type ReasoningEffort = ModelPublic['default_reasoning_effort'];
export type AnalyticsResponseV1 = components['schemas']['AnalyticsResponseV1'];
export type AnalyticsKpiV1 = components['schemas']['AnalyticsKpiV1'];
export type AnalyticsChartBlockV1 = components['schemas']['AnalyticsChartBlockV1'];
export type AnalyticsTableBlockV1 = components['schemas']['AnalyticsTableBlockV1'];
export type AnalyticsExplainerBlockV1 = components['schemas']['AnalyticsExplainerBlockV1'];
export type AnalyticsSeriesV1 = components['schemas']['AnalyticsSeriesV1'];
export type AnalyticsColumnV1 = components['schemas']['AnalyticsColumnV1'];
export type MessageArtifactOut = components['schemas']['MessageArtifactOut'];
