...
Revision ID: 8176374a69ce
Revises: e0c170e6d13b
Create Date: 2026-07-18 11:54:50.183071
...
revision: str = "8176374a69ce"
down_revision: str | Sequence[str] | None = "e0c170e6d13b"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ingest_jobs_document_id"), "ingest_jobs", ["document_id"], unique=False
    )
